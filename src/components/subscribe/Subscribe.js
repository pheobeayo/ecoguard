      ...
      try {
        ...
        await emailjs.send(
          ...
          "template_twj7zn9",
          {
            ...
            from_name: address,
            message: "Hello, I am an Ecoguard subscriber!",
          },
          "EK04mlc-t5tm-hZjF"
        );
      ...
      <div className="">
        ...
        >
          <div className="flex">
            ...
            focus:outline-none focus:border-[#1A1818] bg-transparent"
              placeholder="Email Address"
              value={address}
              onChange={handleChange}
            />
            <button
              className="px-2 sm:px-4 py-2 bg-[#B98D63] text-white
            rounded-r-md hover:bg-[#1A1818] 
            focus:outline-none"
              type="submit"
            >
              Subscribe
